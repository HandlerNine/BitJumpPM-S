...
public class DBController {
    ...
    public List<User> SelectUserInfoAll(){
        SqlSession sqlSession = this.sqlSessionFactory.openSession();

        UsersMapper usersMapper = sqlSession.getMapper(UsersMapper.class);

        var usersInfo = usersMapper.selectAll();
    ...
    public int CommitTask(Integer TaskID, String EndTime, String Remark){
        SqlSession sqlSession = this.sqlSessionFactory.openSession();
        ...
        Integer taskID = tasksMapper.update(taskInfo);
    ...
    public int RefuseTask(Integer TaskID,String Remark){
        SqlSession sqlSession = this.sqlSessionFactory.openSession();
